...
class AnimationConfig{
  ...
  // configuracion de los ciclos de las animaciones de los elementos del juego
  // , en funcion a las imagenes por las que tendremos que secuenciar

  static Future<SpriteAnimation> coinAnimation() => SpriteAnimation.load(
    Globals.coin,
